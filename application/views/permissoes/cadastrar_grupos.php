					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-12 mb-md">
										...
										<input type="text" name="nome" class="form-control" title="Campo obrigatório" value="<?php echo ((isset($descr['nome'])) ? $descr['nome'] : set_value("nome")); ?>" required />
									</div>
									<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<textarea name="description" class="form-control" title="Campo obrigatório" required style="height:112px!important"><?php echo ((isset($descr['description'])) ? $descr['description'] : set_value("description")); ?></textarea>
							</div>
												...
												<tr>
													<td width="35">
														<div class="checkbox-custom chekbox-primary">
															<input type="checkbox" name="permissions[]" value="<?php echo $control->id ?>" data-iscontroller="<?php echo $control->class ?>" <?php $selects = $this->session->userdata('form_selects'); echo (( isset($habilit) && in_array($control->id, $habilit) ) ? "checked" : (( isset($selects) && in_array($control->id, $this->session->userdata('form_selects'))) ? "checked": "")); ?> />
					...
					<footer class="panel-footer">
						<div class="row">
							<div class="col-sm-offset-4 col-sm-2">
								<button name="enviar" class="btn btn-block btn-success">Editar</button>
							</div>
							<div class="col-sm-2">
