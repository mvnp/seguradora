			...
			<form id="form" action="<?php echo base_url(uri_string()) ?>" method="POST" enctype="application/x-www-form-urlencoded" class="form-horizontal" autocomplete="off">
				<section class="panel">
					<header class="panel-heading">
						...
						<div class="row">
							<div class="col-md-9">						
								<h2 class="panel-title"><?=_t("Formulário de edição de e-mail e senha") ?></h2>
								<p class="panel-subtitle">
									<?=_t("Através desse formulário, será possível editar o e-mail e senha de um determinado usuário..") ?>
								</p>
							</div>
							<div class="col-md-3">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="col-sm-6">
								...
								<input type="text" name="email" class="form-control" title="<?=_t("Campo obrigatório.") ?>" value="<?php echo $cad->email; ?>" required />
							</div>
							<div class="col-sm-3">
								<label for="senha" class="control-label"><?=_t("Senha: ") ?><span class="required">*</span></label>
								<input type="password" name="senha" class="form-control" title="<?=_t("Campo obrigatório.") ?>" value="<?php echo set_value('senha'); ?>" />
							</div>
							<div class="col-sm-3">
								<label for="contrasenha" class="control-label"><?=_t("Confirmar senha: ") ?> <span class="required">*</span></label>
								<input type="password" name="contrasenha" class="form-control" title="<?=_t("Campo obrigatório.") ?>" value="<?php echo set_value('contrasenha'); ?>" />
							</div>
						</div>
					<!-- end form -->
					</div>		
					<footer class="panel-footer">
						<div class="row">
							<div class="col-sm-offset-3 col-sm-3">
								<button class="btn btn-block btn-success"><?=_t("Editar") ?></button>
							</div>
							<div class="col-sm-3">
